...
# LOAD DATASET
# ===============================
df = pd.read_csv("../data/COPD.csv")
target_column = "COPDSEVERITY"
...
with open(os.path.join(model_dir, "COPD_best_model.pkl"), "wb") as f:
    pickle.dump(best_model, f)

with open(os.path.join(model_dir, "COPD_scaler.pkl"), "wb") as f:
    pickle.dump(scaler, f)

with open(os.path.join(model_dir, "COPD_features.pkl"), "wb") as f:
    pickle.dump(list(X.columns), f)

# Save accuracies for final comparison graph
pickle.dump(accuracies, open(os.path.join(model_dir, "COPD_model_accuracies.pkl"), "wb"))
