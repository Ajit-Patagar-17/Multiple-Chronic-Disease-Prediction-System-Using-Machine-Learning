...
# Load dataset
df = pd.read_csv("../data/Parkinsons_final.csv")
...
with open(os.path.join(model_dir, "Parkinsons_best_model.pkl"), "wb") as f:
    pickle.dump(best_model, f)
with open(os.path.join(model_dir, "Parkinsons_scaler.pkl"), "wb") as f:
    pickle.dump(scaler, f)
with open(os.path.join(model_dir, "Parkinsons_features.pkl"), "wb") as f:
    pickle.dump(list(X.columns), f)

# Save accuracies for final comparison graph
pickle.dump(accuracies, open(os.path.join(model_dir, "Parkinsons_model_accuracies.pkl"), "wb"))
